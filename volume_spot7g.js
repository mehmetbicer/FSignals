        ...
        request(options, function (error, response) {
            if (error == null || error == "undefined"){
                ...
                paramm_.forEach(element => {
                    if (element.quoteAsset=="USDT" && element.status=="TRADING" && element.isMarginTradingAllowed == true ){
                        //console.log(element.symbol);
                        
                        var inx_ = 0;
                        var inx1_ = 0;
                       
                        inx_ = element.symbol.indexOf("DOWN");
                        inx1_ = element.symbol.indexOf("UP");
